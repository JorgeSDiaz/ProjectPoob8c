...
public class Canvas{
    ...
    public void draw(Object referenceObject, String color, Shape shape, int xCor, int yCor, int angle, boolean isRotate){
    ...
    private class ShapeDescription{
        ...
        public ShapeDescription(Shape shape, String color, int xCor, int yCor, int angle, boolean isRotate){
            this.shape = shape;
            colorString = color;
            this.xCor = xCor;
            this.yCor = yCor;
